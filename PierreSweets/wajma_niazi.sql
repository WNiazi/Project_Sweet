...
CREATE TABLE `FlavorTreats` (
  ...
  `FlavorTreatId1` int(11) DEFAULT NULL,
  PRIMARY KEY (`FlavorTreatId`),
  KEY `IX_FlavorTreats_FlavorId` (`FlavorId`),
  KEY `IX_FlavorTreats_FlavorTreatId1` (`FlavorTreatId1`),
  KEY `IX_FlavorTreats_TreatId` (`TreatId`),
  CONSTRAINT `FK_FlavorTreats_FlavorTreats_FlavorTreatId1` FOREIGN KEY (`FlavorTreatId1`) REFERENCES `flavortreats` (`FlavorTreatId`) ON DELETE RESTRICT,
...
--
-- Dumping events for database 'wajma_niazi'
--
...
-- Dump completed on 2022-04-10 16:26:26
